                ...
                <div class="card-body">
                    <?php
                        ...
                        foreach ($recipes as $recipe) {
                            echo "<table class='table border border-primary border-top' style='border: 1px solid #d4d7dd !important;'>";
                            echo "<tr><td style='border:0px !important'>" . $recipe->name . "</td></tr>";
                            echo "<tr><td style='border:0px !important'>" . $recipe->ingr . "</td></tr>";
                            echo "<tr><td style='border:0px !important'>" . $recipe->proc . "</td></tr>";
                            echo "</table>";
                        }
                        ?>
                </div>
