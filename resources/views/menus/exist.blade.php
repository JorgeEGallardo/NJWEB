        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width:30%; height:25%"><textarea style="margin:0px; padding:0px; height:7em!important;width:100%" 
                    class="form-control" rows="3" disabled>{{$menu->menu}}</textarea>
                    </td>
                    <td style="width:30%; height:25%"><textarea style="margin:0px; padding:0px; height:7em!important;width:100%" 
                    class="form-control" rows="3" disabled>{{$menu->recipes}}</textarea>
                    </td>
